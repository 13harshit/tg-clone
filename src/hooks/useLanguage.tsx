...
const translations: Translations = {
  ...
  'about.description': {
    en: 'Established in 2017, GJ PHARMACEUTICALS has emerged as a pioneering entity in the pharmaceutical industry. As a prominent exporter, manufacturer, and importer, we specialize in a diverse range of high-quality pharmaceutical products.',
    ...
    es: 'Establecida en 2017, GJ PHARMACEUTICALS ha surgido como una entidad pionera en la industria farmacéutica. Como destacado exportador, fabricante e importador, nos especializamos en una amplia gama de productos farmacéuticos de alta calidad.',
    fr: "Fondée en 2017, GJ PHARMACEUTICALS s'est imposée comme une entité pionnière de l'industrie pharmaceutique. En tant qu'exportateur, fabricant et importateur de premier plan, nous sommes spécialisés dans une gamme variée de produits pharmaceutiques de haute qualité.",
    de: 'GJ PHARMACEUTICALS wurde 2017 gegründet und hat sich zu einem Pionierunternehmen in der Pharmaindustrie entwickelt. Als führender Exporteur, Hersteller und Importeur sind wir auf eine vielfältige Palette hochwertiger pharmazeutischer Produkte spezialisiert.',
    ar: 'تأسست شركة GJ PHARMACEUTICALS في عام 2017 ، وبرزت ككيان رائد في صناعة الأدوية. بصفتنا مصدرًا ومصنعًا ومستوردًا بارزًا ، نحن متخصصون في مجموعة متنوعة من المنتجات الصيدلانية عالية الجودة.',
    zh: 'GJ PHARMACEUTICALS成立于2017年，已成为制药行业的先锋实体。作为著名的出口商、制造商和进口商，我们专注于各种高质量的药品。',
    af: 'GJ PHARMACEUTICALS, wat in 2017 gestig is, het as \'n baanbrekersentiteit in die farmaseutiese industrie na vore gekom. As \'n prominente uitvoerder, vervaardiger en invoerder spesialiseer ons in \'n uiteenlopende reeks farmaseutiese produkte van hoë gehalte.',
    be: 'Кампанія GJ PHARMACEUTICALS, заснаваная ў 2017 годзе, стала піянерам у фармацэўтычнай прамысловасці. Як вядучы экспарцёр, вытворца і імпарцёр, мы спецыялізуемся на разнастайным асартыменце высакаякаснай фармацэўтычнай прадукцыі.',
    ca: 'Fundada el 2017, GJ PHARMACEUTICALS ha sorgit com una entitat pionera en la indústria farmacèutica. Com a destacat exportador, fabricant i importador, ens especialitzem en una àmplia gamma de productes farmacèutics d\'alta qualitat.',
    nl: 'GJ PHARMACEUTICALS, opgericht in 2017, heeft zich ontpopt als een baanbrekende entiteit in de farmaceutische industrie. Als prominente exporteur, fabrikant en importeur zijn wij gespecialiseerd in een breed scala aan hoogwaardige farmaceutische producten.',
    id: 'Didirikan pada tahun 2017, GJ PHARMACEUTICALS telah muncul sebagai entitas perintis dalam industri farmasi. Sebagai eksportir, produsen, dan importir terkemuka, kami mengkhususkan diri dalam berbagai macam produk farmasi berkualitas tinggi.',
    it: 'Fondata nel 2017, GJ PHARMACEUTICALS è emersa come un\'entità pionieristica nell\'industria farmaceutica. In qualità di importante esportatore, produttore e importatore, siamo specializzati in una vasta gamma di prodotti farmaceutici di alta qualità.',
    ja: '2017年に設立されたGJ PHARMACEUTICALSは、製薬業界の先駆的な事業体として浮上しました。著名な輸出業者、製造業者、輸入業者として、私たちは高品質の医薬品の多様な範囲を専門としています。',
    ko: '2017년에 설립된 GJ PHARMACEUTICALS는 제약 산업의 선구적인 기업으로 부상했습니다. 저명한 수출업체, 제조업체 및 수입업체로서 당사는 다양한 고품질 의약품을 전문으로 합니다.',
    la: 'Constituta anno 2017, GJ PHARMACEUTICALS emersit ut entitas praevaricatrix in industria pharmaceutica. Ut prominent exportator, fabricator, et importator, specializamus in diversis range summus qualitas pharmaceutica products.',
    pt: 'Fundada em 2017, a GJ PHARMACEUTICALS emergiu como uma entidade pioneira na indústria farmacêutica. Como um proeminente exportador, fabricante e importador, especializamo-nos numa gama diversificada de produtos farmacêuticos de alta qualidade.',
    ru: 'Компания GJ PHARMACEUTICALS, основанная в 2017 году, стала пионером в фармацевтической промышленности. Являясь известным экспортером, производителем и импортером, мы специализируемся на широком спектре высококачественной фармацевтической продукции.',
    tr: '2017 yılında kurulan GJ PHARMACEUTICALS, ilaç endüstrisinde öncü bir kuruluş olarak ortaya çıkmıştır. Önde gelen bir ihracatçı, üretici ve ithalatçı olarak, çok çeşitli yüksek kaliteli farmasötik ürünlerde uzmanlaşmış bulunmaktayız.',
    uk: 'Заснована в 2017 році, GJ PHARMACEUTICALS стала піонером у фармацевтичній промисловості. Як відомий експортер, виробник та імпортер, ми спеціалізуємося на різноманітному асортименті високоякісної фармацевтичної продукції.',
    vi: 'Được thành lập vào năm 2017, GJ PHARMACEUTICALS đã nổi lên như một thực thể tiên phong trong ngành dược phẩm. Là nhà xuất khẩu, sản xuất và nhập khẩu nổi tiếng, chúng tôi chuyên cung cấp nhiều loại sản phẩm dược phẩm chất lượng cao.'
  },
  'about.certified': {
  ...
  'aboutPage.founder': {
    en: 'By working under the able guidance of a trusted leader, Mr. Dhiraj Rathod, GJ PHARMACEUTICALS has attained a competitive market position. The company is based in Mumbai, Maharashtra and was inception in the year 2017.',
    ...
    es: 'Trabajando bajo la guía capaz de un líder confiable, el Sr. Dhiraj Rathod, GJ PHARMACEUTICALS ha alcanzado una posición competitiva en el mercado.',
    fr: 'En travaillant sous la direction compétente d\'un leader de confiance, M. Dhiraj Rathod, GJ PHARMACEUTICALS a atteint une position concurrentielle sur le marché.',
    de: 'Unter der fähigen Leitung eines vertrauenswürdigen Führers, Herrn Dhiraj Rathod, hat GJ PHARMACEUTICALS eine wettbewerbsfähige Marktposition erreicht.',
    ar: 'من خلال العمل تحت التوجيه القدير لزعيم موثوق به ، السيد ديراج راثود ، حققت GJ PHARMACEUTICALS مكانة سوقية تنافسية.',
    zh: '在值得信赖的领导者Dhiraj Rathod先生的干练指导下工作，GJ PHARMACEUTICALS获得了具有竞争力的市场地位。',
    af: 'Deur onder die bekwame leiding van \'n betroubare leier, mnr. Dhiraj Rathod, te werk, het GJ PHARMACEUTICALS \'n mededingende markposisie behaal. Die maatskappy is gebaseer in Mumbai, Maharashtra en is in 2017 gestig.',
    be: 'Працуючы пад умелым кіраўніцтвам даверанага лідэра, спадара Дхіраджа Ратхода, GJ PHARMACEUTICALS дасягнула канкурэнтнай пазіцыі на рынку. Кампанія знаходзіцца ў Мумбаі, Махараштра, і была заснавана ў 2017 годзе.',
    ca: 'Treballant sota la guia capaç d\'un líder de confiança, el Sr. Dhiraj Rathod, GJ PHARMACEUTICALS ha assolit una posició competitiva al mercat. L\'empresa té la seu a Mumbai, Maharashtra i va ser fundada l\'any 2017.',
    nl: 'Door te werken onder de bekwame leiding van een vertrouwde leider, de heer Dhiraj Rathod, heeft GJ PHARMACEUTICALS een concurrerende marktpositie verworven. Het bedrijf is gevestigd in Mumbai, Maharashtra en werd opgericht in 2017.',
    id: 'Dengan bekerja di bawah bimbingan yang cakap dari pemimpin terpercaya, Bapak Dhiraj Rathod, GJ PHARMACEUTICALS telah mencapai posisi pasar yang kompetitif. Perusahaan ini berbasis di Mumbai, Maharashtra dan didirikan pada tahun 2017.',
    it: 'Lavorando sotto la guida capace di un leader fidato, il signor Dhiraj Rathod, GJ PHARMACEUTICALS ha raggiunto una posizione di mercato competitiva. L\'azienda ha sede a Mumbai, Maharashtra ed è stata fondata nel 2017.',
    ja: '信頼できるリーダーであるディラージ・ラソッド氏の有能な指導の下で働くことにより、GJ PHARMACEUTICALSは競争力のある市場地位を獲得しました。同社はマハラシュトラ州ムンバイに拠点を置き、2017年に設立されました。',
    ko: '신뢰할 수 있는 리더인 Dhiraj Rathod 씨의 유능한 지도 아래 GJ PHARMACEUTICALS는 경쟁력 있는 시장 지위를 확보했습니다. 이 회사는 마하라슈트라 주 뭄바이에 본사를 두고 있으며 2017년에 설립되었습니다.',
    la: 'Laborans sub ductu periti ducis, Domini Dhiraj Rathod, GJ PHARMACEUTICALS positionem mercatus competitivam consecuta est. Societas in Mumbai, Maharashtra, fundata est et anno 2017 incepta est.',
    pt: 'Trabalhando sob a orientação capaz de um líder de confiança, o Sr. Dhiraj Rathod, a GJ PHARMACEUTICALS alcançou uma posição de mercado competitiva. A empresa está sediada em Mumbai, Maharashtra e foi fundada no ano de 2017.',
    ru: 'Работая под умелым руководством доверенного лидера, г-на Дхираджа Ратхода, GJ PHARMACEUTICALS заняла конкурентную позицию на рынке. Компания базируется в Мумбаи, Махараштра, и была основана в 2017 году.',
    tr: 'Güvenilir bir lider olan Sayın Dhiraj Rathod\'un yetenekli rehberliğinde çalışarak, GJ PHARMACEUTICALS rekabetçi bir pazar konumu elde etmiştir. Şirket Mumbai, Maharashtra\'da bulunmaktadır ve 2017 yılında kurulmuştur.',
    uk: 'Працюючи під вмілим керівництвом довіреного лідера, пана Дхіраджа Ратхода, GJ PHARMACEUTICALS досягла конкурентної ринкової позиції. Компанія базується в Мумбаї, Махараштра, і була заснована в 2017 році.',
    vi: 'Bằng cách làm việc dưới sự hướng dẫn tài tình của một nhà lãnh đạo đáng tin cậy, ông Dhiraj Rathod, GJ PHARMACEUTICALS đã đạt được vị thế cạnh tranh trên thị trường. Công ty có trụ sở tại Mumbai, Maharashtra và được thành lập vào năm 2017.'
  },
  ...
  'aboutPage.visionDesc': {
    en: 'At GJ PHARMACEUTICALS, our vision is to become a global leader in providing top-notch pharmaceutical products that contribute significantly to the well-being of individuals worldwide.',
    ...
    af: 'By GJ PHARMACEUTICALS is ons visie om \'n wêreldleier te word in die verskaffing van topgehalte farmaseutiese produkte wat beduidend bydra tot die welstand van individue wêreldwyd.',
    be: 'У GJ PHARMACEUTICALS наша мэта - стаць сусветным лідэрам у прадастаўленні першакласных фармацэўтычных прадуктаў, якія значна спрыяюць дабрабыту людзей ва ўсім свеце.',
    ca: 'A GJ PHARMACEUTICALS, la nostra visió és convertir-nos en un líder mundial en la provisió de productes farmacèutics de primera qualitat que contribueixin significativament al benestar de les persones a tot el món.',
    nl: 'Bij GJ PHARMACEUTICALS is onze visie om een wereldleider te worden in het leveren van eersteklas farmaceutische producten die aanzienlijk bijdragen aan het welzijn van individuen wereldwijd.',
    id: 'Di GJ PHARMACEUTICALS, visi kami adalah menjadi pemimpin global dalam menyediakan produk farmasi terbaik yang berkontribusi signifikan terhadap kesejahteraan individu di seluruh dunia.',
    it: 'In GJ PHARMACEUTICALS, la nostra visione è quella di diventare un leader globale nella fornitura di prodotti farmaceutici di prim\'ordine che contribuiscono in modo significativo al benessere degli individui in tutto il mondo.',
    ja: 'GJ PHARMACEUTICALSのビジョンは、世界中の人々の幸福に大きく貢献する最高級の医薬品を提供するグローバルリーダーになることです。',
    ko: 'GJ PHARMACEUTICALS의 비전은 전 세계 개인의 복지에 크게 기여하는 최고 수준의 의약품을 제공하는 글로벌 리더가 되는 것입니다.',
    la: 'Apud GJ PHARMACEUTICALS, visio nostra est fieri princeps globalis in praebendis optimis productis pharmaceuticis quae ad bene esse hominum per orbem terrarum significanter conferunt.',
    pt: 'Na GJ PHARMACEUTICALS, a nossa visão é tornarmo-nos um líder global no fornecimento de produtos farmacêuticos de primeira linha que contribuam significativamente para o bem-estar de indivíduos em todo o mundo.',
    ru: 'В GJ PHARMACEUTICALS наше видение состоит в том, чтобы стать мировым лидером в предоставлении высококачественных фармацевтических продуктов, которые значительно способствуют благополучию людей во всем мире.',
    tr: 'GJ PHARMACEUTICALS olarak vizyonumuz, dünya genelindeki bireylerin refahına önemli ölçüde katkıda bulunan birinci sınıf farmasötik ürünler sunmada küresel bir lider olmaktır.',
    uk: 'У GJ PHARMACEUTICALS наше бачення полягає в тому, щоб стати світовим лідером у наданні першокласних фармацевтичних продуктів, які значно сприяють добробуту людей у всьому світі.',
    vi: 'Tại GJ PHARMACEUTICALS, tầm nhìn của chúng tôi là trở thành nhà lãnh đạo toàn cầu trong việc cung cấp các sản phẩm dược phẩm hàng đầu, đóng góp đáng kể vào phúc lợi của các cá nhân trên toàn thế giới.'
  },

        ...
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-grow pt-32 pb-20">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        <Link to="/products/pharmaceutical/softgel" className="inline-flex items-center text-primary hover:text-primary/80 font-medium transition-colors">
                        ...
                        <div className="p-8 md:p-12 space-y-12">
                            ...
                            <div>
                                ...
                                <p className="text-lg text-secondary max-w-3xl mx-auto">
                                    Discover the power of Soft Gel Capsules: Vitamin A 100000 IU by G J Pharmaceuticals LLP. Our Comprehensive Soft Gel Capsules health supplement is expertly formulated to support heart function and overall cardiovascular well-being. Packed with natural ingredients and backed by science, Soft Gel Capsules promotes healthy blood circulation, maintains optimal cholesterol levels, and supports heart muscle function. Enhance your heart health today with Soft Gel Capsules.
                                </p>
                            </div>
                                ...
                                <table className="w-full text-left border-collapse">
                                    <tbody>
                                        <tr className="border-b border-slate-100">
                                            <th className="p-4 bg-secondary/5 font-semibold text-slate-700">Product Name</th>
                            ...
                            <div>
                                ...
                                <ul className="space-y-4">
                                    <li className="flex gap-4">
                                        <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold text-xs mt-1">1</div>
                                        <div>
                                    ...
                                    <li className="flex gap-4">
                                        <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold text-xs mt-1">2</div>
                                        <div>
                                    ...
                                    <li className="flex gap-4">
                                        <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold text-xs mt-1">3</div>
                                        <div>
                                    ...
                                    <li className="flex gap-4">
                                        <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold text-xs mt-1">4</div>
                                        <div>
                                    ...
                                    <li className="flex gap-4">
                                        <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold text-xs mt-1">5</div>
                                        <div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-300 leading-relaxed">
                                            <strong>Vitamin A Capsules 1,00,000 I.U.</strong> is available for export outside of India. For inquiries regarding bulk orders, pricing, and shipping arrangements, please contact our export department at <Link to="/contact" className="underline text-white hover:text-primary transition-colors">Contact Us</Link>.
                                        </p>
                                    </div>
                                </div>
                            </div>

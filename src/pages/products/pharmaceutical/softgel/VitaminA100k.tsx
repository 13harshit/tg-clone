                        ...
                        <div className="p-8 md:p-12 space-y-12">
                            ...
                            <div>
                                ...
                                <p className="text-lg text-secondary max-w-3xl mx-auto">
                                    Discover the power of Soft Gel Capsules: Vitamin A 100000 IU by GJ PHARMACEUTICALS. Our Comprehensive Soft Gel Capsules health supplement is expertly formulated to support heart function and overall cardiovascular well-being. Packed with natural ingredients and backed by science, Soft Gel Capsules promotes healthy blood circulation, maintains optimal cholesterol levels, and supports heart muscle function. Enhance your heart health today with Soft Gel Capsules.
                                </p>
                            </div>

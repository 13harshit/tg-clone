        ...
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-grow pt-32 pb-20">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        <Link to="/products/pharmaceutical/cardio" className="inline-flex items-center text-primary hover:text-primary/80 font-medium transition-colors">
                    ...
                    <div className="bg-white/60 backdrop-blur-md rounded-3xl shadow-xl overflow-hidden border border-slate-100">
                        ...
                        <div className="bg-gradient-to-r from-secondary to-primary p-8 md:p-12 text-center text-white">
                            <h1 className="text-3xl md:text-5xl font-bold mb-4">Streptokinase</h1>
                            <p className="text-lg text-white/90 max-w-3xl mx-auto">
                                Discover the power of Cardio Care: Streptokinase by G J Pharmaceuticals LLP. Our Comprehensive Cardiovascular health supplement is expertly formulated to support heart function and overall cardiovascular well-being. Packed with natural ingredients and backed by science, Cardio Care promotes healthy blood circulation, maintains optimal cholesterol levels, and supports heart muscle function. Enhance your heart health today with Cardio Care.
                            </p>
                        </div>
                        ...
                        <div className="p-8 md:p-12 space-y-12">
                            ...
                            <div>
                                <p className="text-slate-600 leading-relaxed text-lg mb-6">
                                    Discover the power of Cardio Care: <strong>Streptokinase</strong> by G J Pharmaceuticals LLP. Our Comprehensive Cardiovascular health supplement is expertly formulated to support heart function and overall cardiovascular well-being. Packed with natural ingredients and backed by science, Cardio Care promotes healthy blood circulation, maintains optimal cholesterol levels, and supports heart muscle function. Enhance your heart health today with Cardio Care.
                                </p>
                            </div>
                                ...
                                <table className="w-full text-left border-collapse">
                                    <tbody>
                                        <tr className="border-b border-slate-100">
                                            ...
                                            <td className="p-4 text-slate-600">Streptokinase</td>
                                        </tr>
                                        <tr className="border-b border-slate-100">
                                            <th className="p-4 bg-secondary/5 font-semibold text-slate-700">Product Strength</th>
                                            <td className="p-4 text-slate-600">1500000 IU, 750000 IU</td>
                                        </tr>
                                        <tr className="border-b border-slate-100">
                            ...
                            <div className="bg-primary/5 border border-primary/10 p-4 rounded-lg text-primary text-sm font-medium">
                                Packaging: Streptokinase Packaging size is available VIAL
                            </div>

                            <div className="bg-secondary/5 p-6 rounded-xl border border-slate-100">
                                <p className="text-slate-600 text-sm leading-relaxed">
                                    Streptokinase is available in bottles containing 60 softgel capsules, providing a convenient supply for one month’s use. Each bottle is securely sealed to maintain product freshness and potency.
                                </p>
                            </div>
                            ...
                            <div>
                                <h2 className="text-2xl font-bold text-slate-900 mb-4 flex items-center">
                                    ...
                                    Usage Directions: Streptokinase
                                </h2>
                                <p className="text-slate-600 leading-relaxed bg-secondary/5 p-6 rounded-xl border border-slate-100">
                            ...
                            <div>
                                <h2 className="text-2xl font-bold text-slate-900 mb-6 flex items-center">
                                    ...
                                    Safety Information: Streptokinase
                                </h2>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-300 leading-relaxed">
                                            <strong>Streptokinase</strong> is available for export outside of India. For inquiries regarding bulk orders, pricing, and shipping arrangements, please contact our export department at <Link to="/contact" className="underline text-white hover:text-primary transition-colors">Contact Us</Link>.
                                        </p>
                                    </div>
                                </div>
                            </div>

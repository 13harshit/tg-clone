                    ...
                    <div className="bg-white/60 backdrop-blur-md rounded-3xl shadow-xl overflow-hidden border border-slate-100">
                        ...
                        <div className="bg-gradient-to-r from-secondary to-primary p-8 md:p-12 text-center text-white">
                            ...
                            <p className="text-lg text-white/90 max-w-3xl mx-auto">
                                Discover the power of Cardio Care: Caspofungin by GJ PHARMACEUTICALS. Our Comprehensive Cardiovascular health supplement is expertly formulated to support heart function and overall cardiovascular well-being. Packed with natural ingredients and backed by science, Cardio Care promotes healthy blood circulation, maintains optimal cholesterol levels, and supports heart muscle function. Enhance your heart health today with Cardio Care.
                            </p>
                        </div>
                        ...
                        <div className="p-8 md:p-12 space-y-12">
                            ...
                            <div>
                                <p className="text-slate-600 leading-relaxed text-lg mb-6">
                                    Discover the power of Cardio Care: <strong>Caspofungin</strong> by GJ PHARMACEUTICALS. Our Comprehensive Cardiovascular health supplement is expertly formulated to support heart function and overall cardiovascular well-being. Packed with natural ingredients and backed by science, Cardio Care promotes healthy blood circulation, maintains optimal cholesterol levels, and supports heart muscle function. Enhance your heart health today with Cardio Care.
                                </p>
                            </div>

            ...
            <section className="container-custom py-20">
                <div className="max-w-5xl mx-auto space-y-20">
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-3xl p-8 md:p-12 border border-gray-200">
                        <h2 className="text-3xl font-bold mb-8 text-primary border-b border-gray-200 pb-4 inline-block">Why Choose G J Pharmaceuticals LLP?</h2>
                        <div className="space-y-6">
                            ...
                            <p className="text-lg font-medium text-primary pt-6 italic border-t border-primary/10 mt-6">
                                Indulge in the culinary excellence of G J Pharmaceuticals LLP. Elevate your dishes with the finest Food Grains, Oils & Spices that redefine gourmet cooking and bring the essence of quality to your kitchen.
                            </p>
                        </div>
                    </div>

                        ...
                        <div className="absolute top-1/2 right-4 md:right-12 -translate-y-1/2 max-w-xl w-full">
                            ...
                            >
                                ...
                                <p className="text-slate-800 font-medium leading-relaxed">
                                    G J Pharmaceuticals LLP offers comprehensive Contract Manufacturing solutions across a spectrum of industries. Leveraging our state-of-the-art facilities, expertise, and a commitment to quality, we partner with businesses seeking reliable and high-quality manufacturing services.
                                </p>
                            </motion.div>
                        </div>
                    </div>
                ...
                <div className="container-custom">
                    ...
                    >
                        ...
                        <p className="text-muted-foreground">
                            Whether you’re seeking a reliable partner for manufacturing your products or looking to outsource production processes, G J Pharmaceuticals LLP offers the expertise, facilities, and dedication necessary to bring your vision to fruition.
                        </p>
                    </motion.div>

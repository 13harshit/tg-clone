                        ...
                        >
                            <div className="bg-white p-8 md:p-10 rounded-3xl shadow-2xl border border-slate-100">
                                ...
                                <p className="text-slate-600 font-medium leading-relaxed">
                                    At G J Pharmaceuticals LLP, our extensive sales and distribution network forms the backbone of our global reach. We take pride in our robust network that ensures efficient, timely, and widespread availability of our diverse range of products across the globe.
                                </p>
                            </div>
                        </motion.div>
                    </div>
                ...
                <div className="container-custom">
                    ...
                    >
                        ...
                        <p className="text-muted-foreground text-lg leading-relaxed">
                            At G J Pharmaceuticals LLP, our sales and distribution network isn’t just about moving products—it’s about building lasting partnerships, ensuring accessibility, and delivering excellence across borders.
                        </p>
                    </motion.div>
